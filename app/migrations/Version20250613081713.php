 ...
 */
final class Version20250613081713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE item (guid UUID NOT NULL, brand_guid UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, publish_state VARCHAR(50) NOT NULL, sku VARCHAR(50) NOT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, breadcrumbs JSON NOT NULL, PRIMARY KEY(guid))
        SQL);
        $this->addSql(<<<'SQL'
